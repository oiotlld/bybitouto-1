...
while True:
    try:
        ...
        if buy_size >gty_c:
            buy_j = round(buy_entry_price*0.0001,sosu)
        elif buy_size <= gty_c:
            buy_j = round(buy_entry_price*0.002,sosu)
        else:
            pass
        if sell_size > gty_c:
            sell_j = round(sell_entry_price*0.0001,sosu)
        elif sell_size <= gty_c:
            sell_j = round(sell_entry_price*0.002,sosu)
        else:
            pass
