...
while True:
    try:
        ...
        if time_s == 0 or time_s==10 or time_s==20 or time_s==30 or time_s==40 or time_s==50:
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol="BTCUSDT",order_type="Limit",qty=buy_size,price = buy_entry_price+0.0003,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol="BTCUSDT",order_type="Limit",qty=sell_size,price = sell_entry_price-0.0003,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
        else:
            pass
