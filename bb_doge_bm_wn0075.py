...
while True:
    try:
        ...
        if 500 > my_usdt:
            ...
            now_qty20 = (my_usdt/now_close)/40000
        elif 10000 < my_usdt:
            now_qty20 = (my_usdt/now_close)/40000
        else:
            pass
        ...
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(16*(now_qty20),0) ,price =a-(0) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(16*(now_qty20),0) ,price =a-(0.0001) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(28*(now_qty20),0) ,price =a-(0.0002) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(28*(now_qty20),0) ,price =a-(0.0003) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(48*(now_qty20),0) ,price =a-(0.0004) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(48*(now_qty20),0) ,price =a-(0.0005) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(80*(now_qty20),0) ,price =a-(0.0006) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(80*(now_qty20),0) ,price =a-(0.0007),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(128*(now_qty20),0) ,price =a-(0.0008),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(128*(now_qty20),0) ,price =a-(0.0009),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(192*(now_qty20),0),price =a-(0.0011),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(192*(now_qty20),0),price =a-(0.0013) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(384*(now_qty20),0),price =a-(0.0015) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(384*(now_qty20),0),price =a-(0.0017) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a-(0.0019) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a-(0.0021) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a-(0.0023) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a-(0.0025) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(768*(now_qty20),0),price =a-(0.0027) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(768*(now_qty20),0),price =a-(0.0029),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(1152*(now_qty20),0),price =a-(0.0032),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(1152*(now_qty20),0),price =a-(0.0035) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(1728*(now_qty20),0),price =a-(0.0038) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(1728*(now_qty20),0),price =a-(0.0041) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(2592*(now_qty20),0),price =a-(0.0044) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(2592*(now_qty20),0),price =a-(0.0047) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(3888*(now_qty20),0),price =a-(0.0050) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(3888*(now_qty20),0),price =a-(0.0053) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())

        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(5832*(now_qty20),0),price =a-(0.0056) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(7582*(now_qty20),0),price =a-(0.0059) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(9856*(now_qty20),0),price =a-(0.0063) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(12813*(now_qty20),0),price =a-(0.0072) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(16657*(now_qty20),0),price =a-(0.0086) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(21654*(now_qty20),0),price =a-(0.0105) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            
            
        #     # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(28150*(now_qty20),0),price =a-(0.0129) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(36595*(now_qty20),0),price =a-(0.0158) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        ...
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(16*(now_qty20),0),price =a_1+(0) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(16*(now_qty20),0),price =a_1+(0.0001) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(28*(now_qty20),0),price =a_1+(0.0002) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(28*(now_qty20),0),price =a_1+(0.0003) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(48*(now_qty20),0),price =a_1+(0.0004) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(48*(now_qty20),0),price =a_1+(0.0005) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(80*(now_qty20),0),price =a_1+(0.0006) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(80*(now_qty20),0),price =a_1+(0.0007),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(128*(now_qty20),0),price =a_1+(0.0008),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(128*(now_qty20),0),price =a_1+(0.0009),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(192*(now_qty20),0),price =a_1+(0.0011),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(192*(now_qty20),0),price =a_1+(0.0013) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(384*(now_qty20),0),price =a_1+(0.0015) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(384*(now_qty20),0),price =a_1+(0.0017) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a_1+(0.0019) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a_1+(0.0021) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a_1+(0.0023) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(512*(now_qty20),0),price =a_1+(0.0025) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(768*(now_qty20),0),price =a_1+(0.0027) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(768*(now_qty20),0),price =a_1+(0.0029),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(1152*(now_qty20),0),price =a_1+(0.0032),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(1152*(now_qty20),0),price =a_1+(0.0035) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(1728*(now_qty20),0),price =a_1+(0.0038) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(1728*(now_qty20),0),price =a_1+(0.0041) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(2592*(now_qty20),0),price =a_1+(0.0044) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(2592*(now_qty20),0),price =a_1+(0.0047) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(3888*(now_qty20),0),price =a_1+(0.0050) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(3888*(now_qty20),0),price =a_1+(0.0053) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())

        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(5832*(now_qty20),0),price =a_1+(0.0056) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(7582*(now_qty20),0),price =a_1+(0.0059) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(9856*(now_qty20),0),price =a_1+(0.0063) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(12813*(now_qty20),0),price =a_1+(0.0072) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(16657*(now_qty20),0),price =a_1+(0.0086) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(21654*(now_qty20),0),price =a_1+(0.0105) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            
            
            
        #     # print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(28150*(now_qty20),0),price =a_1+(0.0129) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     # print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(36595*(now_qty20),0),price =a_1+(0.0158) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        ...
        # print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=buy_size,price = buy_entry_price+0.0005,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
    
        # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=sell_size,price = sell_entry_price-0.0005,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
        ...
        # # if now_close >= buy_entry_price+0.0007 and 0 < buy_size <= gty_d:
        ...
        # # if now_close <= sell_entry_price-0.0007 and 0 < sell_size <= gty_d:
