...
while True:
    try:
        ...
        qty_1= 0
        qty_2=round(0.0003186743*now_close,0)
        qty_3=round(0.0007488846*now_close,0)
        qty_4=round(0.001290631*now_close,0)
        qty_5=round(0.0019439133*now_close,0)
        qty_6=round(0.0027087317*now_close,0)
        qty_7=round(0.003585086*now_close,0)
        qty_8=round(0.0045729764*now_close,0)
        qty_9=round(0.0056724028*now_close,0)
        qty_10=round(0.0068833652*now_close,0)
        qty_11=round(0.0082058636*now_close,0)
        qty_12=round(0.009639898*now_close,0)
        qty_13=round(0.0111854685*now_close,0)
        qty_14=round(0.0128425749*now_close,0)
        qty_15=round(0.0146112173*now_close,0)
        qty_16=round(0.0164913958*now_close,0)
        qty_17=round(0.0184831103*now_close,0)
        qty_18=round(0.0205863607*now_close,0)
        qty_19=round(0.0228011472*now_close,0)
        qty_20=round(0.0251274697*now_close,0)
        qty_21=round(0.0275653282*now_close,0)
        qty_22=round(0.0301147228*now_close,0)
        qty_23=round(0.0327756533*now_close,0)
        qty_24=round(0.0355481198*now_close,0)
        qty_25=round(0.0384321224*now_close,0)
        qty_26=round(0.0414276609*now_close,0)
        qty_27=round(0.0445347355*now_close,0)
        qty_28=round(0.0477533461*now_close,0)
        qty_29=round(0.0510834927*now_close,0)
        qty_30=round(0.0545251753*now_close,0)


        price_1=round(0.06*(now_qty20),2)
        price_2=round(0.06*(now_qty20),2)
        price_3=round(0.06*(now_qty20),2)
        price_4=round(0.06*(now_qty20),2)
        price_5=round(0.06*(now_qty20),2)
        price_6=round(0.06*(now_qty20),2)
        price_7=round(0.06*(now_qty20),2)
        price_8=round(0.06*(now_qty20),2)
        price_9=round(0.06*(now_qty20),2)
        price_10=round(0.06*(now_qty20),2)
        price_11=round(0.08*(now_qty20),2)
        price_12=round(0.08*(now_qty20),2)
        price_13=round(0.08*(now_qty20),2)
        price_14=round(0.08*(now_qty20),2)
        price_15=round(0.08*(now_qty20),2)
        price_16=round(0.08*(now_qty20),2)
        price_17=round(0.09*(now_qty20),2)
        price_18=round(0.11*(now_qty20),2)
        price_19=round(0.26*(now_qty20),2)
        price_20=round(0.31*(now_qty20),2)
        price_21=round(0.41*(now_qty20),2)
        price_22=round(0.52*(now_qty20),2)
        price_23=round(0.68*(now_qty20),2)
        price_24=round(0.86*(now_qty20),2)
        price_25=round(1.12*(now_qty20),2)
        price_26=round(1.34*(now_qty20),2)
        price_27=round(1.69*(now_qty20),2)
        price_28=round(2.02*(now_qty20),2)
        price_29=round(2.58*(now_qty20),2)
        price_30=round(3.31*(now_qty20),2)
