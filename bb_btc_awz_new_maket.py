...
while True:
    try:
        ...
        #  #시장가 청산하기    
        if now_close >= buy_entry_price+buy_j3+10 and size_abs < 0.05:
        ...
        if now_close <= sell_entry_price-sell_j3-10 and size_abs < 0.05:
        ...
        if now_close <= sell_entry_price-sell_j3-10 and size_abs >= 0.05:
         ...
         #양매수 시장가 청산하기    
        if close_all_3 > 0.003 and (size_abs < 0.1):
        ...
        if close_all_3 > 0.003 and (size_abs < 0.1):
         ...
         #양매수 시장가 청산하기    
        if close_haf_3 > 0.001 and (size_abs > 0.1):
