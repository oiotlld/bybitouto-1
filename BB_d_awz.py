...
while True:
    try:
        ...
        if time_s == 0 or time_s == 10  or time_s == 20 or time_s == 30 or time_s == 40 or time_s == 50 : # 초단위 카운팅 0 = 1분
            ...
            #청산하기 2~3틱먹기
            if buy_entry_price != 0 and buy_entry_price > 15000:
                buy_j=round(buy_entry_price+0.0000,4)
            else:
                pass
            if sell_entry_price != 0 and sell_entry_price > 15000:
                sell_j=round(sell_entry_price-0.0000,4)
            else:
                pass
