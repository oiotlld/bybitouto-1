...
while True:
    try:
        ...
        if re_len >= 1 :
            ...
            query_1 = 3
        if query_1 == 1 :
            query_3 = my_query[0]["result"][0]["order_id"]
        else:
            query_3 = 0
        ...
        if re_len >= 2 :
            ...
            query_2 = 3
        if query_2 == 1 :
            query_4 = my_query[0]["result"][0]["order_id"]
        else:
            query_4 = 0
        ...
        if time_s == 0 or time_s == 1  : # 초단위 카운팅 0 = 1분
            ...
            if (round(abs(0.0020/now_close),4) < buy_geb or round(abs(0.0022/now_close),4) <sell_geb) and (sell_size > gty_d or buy_size > gty_d):
                ...
                price_2=[0]
            if buy_size >= gty_d and round(abs(0.0005/now_close),4) < buy_geb:
            ...
            if sell_size >= gty_d and round(abs(0.0005/now_close),4) < sell_geb:
                for m in price_2:
        ...
        if time_s == 0 or time_s == 10  or time_s == 20 or time_s == 30 or time_s == 40 or time_s == 50 : # 초단위 카운팅 0 = 1분
            #청산 주문 취소하기
            if query_1 == 1:
                my_id1 = query_3
            else:
            ...
            if (buy_size != 0 and buy_size < gty_d)  or  round(abs(0.0005/now_close),4) > buy_geb:
            ...
            if (sell_size != 0 and sell_size < gty_d)  or  round(abs(0.0005/now_close),4) > sell_geb :
