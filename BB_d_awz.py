...
while True:
    try:
        ...
        qty_l=[2,2,4,8,16,32,64,128,256,256,256,256,256,256,256]
        price_l=[0,0.0001,0.0002,0.0004,0.0006,0.0008,0.0010,0.0012,0.0014,0.0016,0.0018,0.0020,0.0022,0.0024,0.0026]
