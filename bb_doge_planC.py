...
while True:
    try:
       ...
       #========================================각 포지션별 주문 갯수 구하기=========================================================================
        ...
        #지정가 청산주문
        if time_s == 0 or time_s == 1  or re_len > 99 and my_leverage != 50 and my_stop==0:
        ...
        # if (bb_l > now_close ) and  buy_cls == 0  and my_leverage != 50  and my_stop==0 and buy_size < (gty_c*10) and bb_l_60 > now_close:
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+0.0000),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+0.0002),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+0.0003),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        ...
        # elif (bb_u < now_close ) and  sell_cls == 0  and my_leverage != 50 and my_stop==0 and sell_size < (gty_c*10) and bb_u_60 < now_close:
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+0.0000),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+0.0002),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+0.0003),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        ...
        if buy_size_d < gty_c and math.ceil((buy_size_d)/ssall) != math.ceil(buy_close2/ssall) and buy_size > sell_size and my_leverage != 50 and my_stop==0 :
        ...
        elif buy_size_d >= gty_c and buy_close2 ==0  and buy_size > sell_size and my_leverage != 50 and my_stop==0  and buy_entry_price <= now_close and bb_l_60 <= now_close:
            ...
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0001,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0002,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0003,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0004,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0005,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0006,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0007,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0008,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d-gty_c)/10,0) ,price =round(now_close+0.0009,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
        ...
        if sell_size_d < gty_c  and math.ceil((sell_size_d)/ssall) != math.ceil(sell_close2/ssall)  and buy_size < sell_size  and my_leverage != 50 and my_stop==0:                
        ...
        elif sell_size_d >= gty_c and sell_close2 ==0  and buy_size < sell_size and my_leverage != 50 and my_stop==0 and sell_entry_price >= now_close  and bb_u_60 >= now_close:
            ...
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0001,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0002,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0003,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0004,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0005,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0006,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0007,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0008,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d-gty_c)/10,0) ,price =round(now_close-0.0009,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
    ...
    # 수량이 차면 양매수를 걸어라
        if buy_size_d > gty_b and ((buy_size_d/2)-sell_cls) > gty_b/2 and round(bb_l-(bb_l*0.01),4) < now_close and my_leverage != 50 and my_stop==0:
        ...
        elif sell_size_d > gty_b and ((sell_size_d/2)-buy_cls) > gty_b/2 and round(bb_u+(bb_u*0.01),4) > now_close and my_leverage != 50 and my_stop==0:
        ...
        if buy_size > gty_c*10 and buy_size > sell_size:
            ...
            pass
        if sell_size > gty_c*10 and buy_size < sell_size:
        ...
        if close_all_3 >= 0.0025 and buy_size != 0 and sell_size != 0 and my_leverage != 50 and my_stop==0:
        ...
        #  양매수 시장가 청산하기    0.01= 1%수익
        if close_a_3 >= 0.0035 and buy_size != 0 and sell_size != 0 and my_leverage != 50 :
