...
while True:
    ...
    #=======================================================================================================    ===============================================================================================================================================================
        ...
        #시장가 청산주문
        if buy_size > sell_size and my_leverage != 50 and my_stop==0 and round(buy_j6,4) < now_close and sell_size == 0 and buy_size_d < gty_c:
        ...
        elif buy_size < sell_size  and my_leverage != 50 and my_stop==0 and round(sell_j6,4) > now_close  and buy_size == 0 and sell_size_d < gty_c:
