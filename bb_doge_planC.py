...
while True:
    try:
       ...
       #========================================각 포지션별 주문 갯수 구하기=========================================================================
        ...
        #1%
        buy_j5 = round(now_close*0.008,4)
        #볼린저상하단 터치시 청산주문
        if buy_entry_price >= bb_u_60:
           buy_j6 = buy_entry_price+buy_j4
        elif buy_entry_price < bb_u_60:
            buy_j6 = bb_u_60
        else:
            pass

        if sell_entry_price <= bb_l_60:
           sell_j6 = sell_entry_price-buy_j4
        elif sell_entry_price > bb_l_60:
            sell_j6 = bb_l_60
        else:
            pass
    ...
    #=======================================================================================================    ===============================================================================================================================================================
        ...
        #5분 단위구분
        if time_m == 5 or time_m == 10 or time_m == 15  or time_m == 20 or time_m == 25 or time_m == 30 or time_m == 35 or time_m == 40 or time_m == 45 or time_m == 50 or time_m == 55 or time_m == 0:
            time_5m = 1
        else:
            time_5m = 0 

        #지정가 청산주문
        if time_m == 0 and (time_s == 0 or time_s == 1  or time_s == 2) and my_leverage != 50 and my_stop==0:
        ...
        if buy_cls == 0  and my_leverage != 50  and my_stop==0 and buy_size < (gty_c*15) and bb_l_60 > now_close and sell_en > now_close and buy_entry_price > now_close:
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(500*now_qty20,0),price =round(bb_l_60-(0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(500*now_qty20,0),price =round(now_close-(buy_j5),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(1000*now_qty20,0),price =round(now_close-(buy_j5+0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(2000*now_qty20,0),price =round(now_close-(buy_j5+0.0002),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(4000*now_qty20,0),price =round(now_close-(buy_j5+0.0004),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(8000*now_qty20,0),price =round(now_close-(buy_j5+0.0006),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10,0),price =round(now_close-(buy_j5+0.0005),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10,0),price =round(now_close-(buy_j5+0.0006),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/9,0),price =round(now_close-(buy_j5+0.0008),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/8,0),price =round(now_close-(buy_j5+0.0015),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/7,0),price =round(now_close-(buy_j5+0.0020),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/6,0),price =round(now_close-(buy_j5+0.0025),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())

            

        elif sell_cls == 0  and my_leverage != 50 and my_stop==0 and sell_size < (gty_c*15) and bb_u_60 < now_close and sell_entry_price < now_close and buy_entry_price < now_close:
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(500*now_qty20,0),price =round(bb_u_60+(0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(500*now_qty20,0),price =round(now_close+(buy_j5),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(1000*now_qty20,0),price =round(now_close+(buy_j5+0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(2000*now_qty20,0),price =round(now_close+(buy_j5+0.0002),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(4000*now_qty20,0),price =round(now_close+(buy_j5+0.0004),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(8000*now_qty20,0),price =round(now_close+(buy_j5+0.0006),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        ...
        #지정가 청산주문
        if buy_size_d < gty_c and math.ceil((buy_size_d)/100) != math.ceil(buy_close2/100) and buy_size > sell_size and my_leverage != 50 and my_stop==0 :
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=buy_size_d-buy_close2,price = round(buy_j6,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
        
        elif buy_size_d >= gty_c and buy_size > sell_size and my_leverage != 50 and my_stop==0 and buy_entry_price < now_close and sell_cls==0 and math.ceil((buy_size_d)/1000) != math.ceil(buy_close2/1000) and sell_size == 0:
        ...
        if sell_size_d < gty_c  and math.ceil((sell_size_d)/100) != math.ceil(sell_close2/100)  and buy_size < sell_size  and my_leverage != 50 and my_stop==0:                
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=sell_size_d-sell_close2,price = round(sell_j6,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
        
       
        elif sell_size_d >= gty_c  and buy_size < sell_size and my_leverage != 50 and my_stop==0 and sell_entry_price > now_close and buy_cls==0 and math.ceil((sell_size_d)/1000) != math.ceil(sell_close2/1000) and buy_size == 0:
        ...
        #시장가 청산주문
        if buy_size > sell_size and my_leverage != 50 and my_stop==0 and round(buy_j6,4) < now_close and sell_size == 0 and buy_size_d < gty_c and round(buy_entry_price+buy_j4,4) < now_close:
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=buy_size_d,price = round(buy_entry_price+buy_j4,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
        
        elif buy_size < sell_size  and my_leverage != 50 and my_stop==0 and round(sell_j6,4) > now_close  and buy_size == 0 and sell_size_d < gty_c and round(sell_entry_price-buy_j4,4) > now_close:
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=sell_size_d,price = round(sell_entry_price-buy_j4,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
    ...
    # 수량이 차면 양매수를 걸어라
        if buy_size_d > gty_c*4 and my_leverage != 50 and my_stop==0:
             # 1배이상 싸이면 반대포지션을 지정가로 양매수 걸어라 초당1배수량제외한 나머지 차이의 20분에1을 걸어라
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=round((buy_size_d)/500,0) ,price =round(now_close+0.0001,4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
           
         
        elif sell_size_d > gty_c*4 and my_leverage != 50 and my_stop==0:
            # 1배이상 싸이면 반대포지션을 지정가로 양매수 걸어라 초당1배수량제외한 나머지 차이의 20분에1을 걸어라
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=round((sell_size_d)/500,0) ,price =round(now_close+0.0001,4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        ...
        if close_all_3 >= (0.0001/now_close) and buy_size != 0 and sell_size != 0 and my_leverage != 50 and my_stop==0:
        ...
        #  양매수 시장가 청산하기    0.01= 1%수익
        if close_a_3 >= (0.0006/now_close) and size_abs < gty_c*1 and buy_size != 0 and sell_size != 0 and my_leverage != 50 :
            ...
            my_stop=0
        elif close_a_3 >= (0.0005/now_close) and size_abs < gty_c*2 and buy_size != 0 and sell_size != 0 and my_leverage != 50 :
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=close_b_2,price = buy_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=close_s_2,price = sell_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            my_stop=0   
            
        elif close_a_3 >= (0.0004/now_close) and size_abs < gty_c*3 and buy_size != 0 and sell_size != 0 and my_leverage != 50 :
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=close_b_2,price = buy_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=close_s_2,price = sell_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            my_stop=0  
        
        elif close_a_3 >= (0.0003/now_close) and size_abs < gty_c*4 and buy_size != 0 and sell_size != 0 and my_leverage != 50 :
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=close_b_2,price = buy_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=close_s_2,price = sell_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            my_stop=0  
        elif close_a_3 >= (0.0002/now_close) and size_abs > gty_c*4 and buy_size != 0 and sell_size != 0 and my_leverage != 50 :
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=close_b_2,price = buy_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=close_s_2,price = sell_entry_price,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
            my_stop=0  
        else:
