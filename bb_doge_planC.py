...
while True:
    ...
    #=======================================================================================================    ===============================================================================================================================================================
        ...
        if buy_cls == 0  and my_leverage != 50  and my_stop==0 and buy_size < (gty_c*15) and bb_l_60 > now_close and sell_en > now_close and buy_entry_price > now_close:
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(500,0),price =round(bb_l_60-(0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(500,0),price =round(now_close-(buy_j5),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(1000,0),price =round(now_close-(buy_j5+0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(1500,0),price =round(now_close-(buy_j5+0.0002),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(2000,0),price =round(now_close-(buy_j5+0.0004),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10,0),price =round(now_close-(buy_j5+0.0004),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            ...
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(500,0),price =round(bb_u_60+(0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(500,0),price =round(now_close+(buy_j5),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(1000,0),price =round(now_close+(buy_j5+0.0001),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(1500,0),price =round(now_close+(buy_j5+0.0002),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(2000,0),price =round(now_close+(buy_j5+0.0004),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
    ...
    # 수량이 차면 양매수를 걸어라
        if buy_size_d > gty_c*4 and my_leverage != 50 and my_stop==0:
            ...
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=round((buy_size_d)/150,0) ,price =round(now_close+0.0001,4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
           
         
        elif sell_size_d > gty_c*4 and my_leverage != 50 and my_stop==0:
            # 1배이상 싸이면 반대포지션을 지정가로 양매수 걸어라 초당1배수량제외한 나머지 차이의 20분에1을 걸어라
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=round((sell_size_d)/150,0) ,price =round(now_close+0.0001,4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
