...
while True:
    try:
        ...
        if 500 > my_usdt:
            ...
            now_qty20 = round((my_usdt*now_close)/200,0)
        elif 10000 < my_usdt:
            now_qty20 = round((10000*now_close)/200,0)
        else:
            pass
        ...
        if (h_close <= average20 and now_open >= average20)  and (time_s == 0 or time_s==1): # 현재가가 볼린전 중단(20일이평선)을 하향 돌파시
            ...
            if buy_size < gty_d:
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=16*(now_qty20) ,price =a-(0) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=16*(now_qty20) ,price =a-(0.0001) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=28*(now_qty20) ,price =a-(0.0002) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=28*(now_qty20) ,price =a-(0.0003) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=48*(now_qty20) ,price =a-(0.0004) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=48*(now_qty20) ,price =a-(0.0005) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=80*(now_qty20) ,price =a-(0.0006) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=80*(now_qty20) ,price =a-(0.0007),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=128*(now_qty20) ,price =a-(0.0008),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=128*(now_qty20) ,price =a-(0.0009),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=192*(now_qty20),price =a-(0.0011),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=192*(now_qty20),price =a-(0.0013) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=384*(now_qty20),price =a-(0.0015) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=384*(now_qty20),price =a-(0.0017) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=512*(now_qty20),price =a-(0.0019) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=512*(now_qty20),price =a-(0.0021) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                ...
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=5832*(now_qty20),price =a-(0.0156) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=5832*(now_qty20),price =a-(0.0212) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=5832*(now_qty20),price =a-(0.0273) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                ...
                #청산주문
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=buy_size,price = buy_entry_price+0.0002,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            
                print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=sell_size,price = sell_entry_price-0.0002,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
        ...
        if h_close >= average20 and now_open <= average20  and (time_s == 0 or time_s==1): # 현재가가 볼린전 중단(20일이평선)을 상향 돌파시
            ...
            if sell_size < gty_d:
                ...
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=16*(now_qty20),price =a_1+(0) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=16*(now_qty20),price =a_1+(0.0001) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=28*(now_qty20),price =a_1+(0.0002) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=28*(now_qty20),price =a_1+(0.0003) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=48*(now_qty20),price =a_1+(0.0004) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=48*(now_qty20),price =a_1+(0.0005) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=80*(now_qty20),price =a_1+(0.0006) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=80*(now_qty20),price =a_1+(0.0007),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=128*(now_qty20),price =a_1+(0.0008),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=128*(now_qty20),price =a_1+(0.0009),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=192*(now_qty20),price =a_1+(0.0011),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=192*(now_qty20),price =a_1+(0.0013) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=384*(now_qty20),price =a_1+(0.0015) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=384*(now_qty20),price =a_1+(0.0017) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=512*(now_qty20),price =a_1+(0.0019) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=512*(now_qty20),price =a_1+(0.0021) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                ...
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=5832*(now_qty20),price =a_1+(0.0156) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=5832*(now_qty20),price =a_1+(0.0212) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=5832*(now_qty20),price =a_1+(0.0273) ,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        ...
        if time_s == 2 or time_s==10 or time_s==20 or time_s==30 or time_s==40 or time_s==50:
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=buy_size_4,price = buy_entry_price+0.0002,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=sell_size_4,price = sell_entry_price-0.0002,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
        else:
            pass
        ...
        if now_close >= buy_entry_price+0.0006 and buy_size_d < gty_c:
        ...
        if now_close <= sell_entry_price-0.0006 and sell_size_d < gty_c:
