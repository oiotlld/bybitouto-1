...
while True:
    ...
    # 수량이 차면 양매수를 걸어라
        ...
        if buy_size > gty_c*12 and buy_size > sell_size:
            ...
            pass
        if sell_size > gty_c*12 and buy_size < sell_size:
        ...
        #  양매수 시장가 청산하기    0.01= 1%수익
        if close_a_3 >= 0.0025 and buy_size != 0 and sell_size != 0 and my_leverage != 50 :
