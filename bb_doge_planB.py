...
while True:
    try:
       ...
       #========================================각 포지션별 주문 갯수 구하기=========================================================================
        ...
        # 위험수량 결정 자본금의 7배 이상      
        gty_d = round((my_usdt/now_close)*16,0)

        # 기본 수량 계산 - 반대포지션이 이수량되면 두배매수
        gty_c = round((my_usdt/now_close)*1,0)

        # 양매수 기준수량
        gty_b = round((my_usdt/now_close)*3,0)
        ...
        if 500 > my_usdt:
            now_qty20 = (my_usdt/now_close)/3500 
        ...
        for i in range(0, 59):
            if time_s == i:
                ...
                for g in range(0, 100):
                    if now_close == round((bb_l) -(g*0.0001),4) and buy_size_d < gty_d and bb_l > now_close and buy_stop !=1 and sell_stop2 !=1:
                    ...
                    elif now_close == round((bb_l) -(g*0.0001),4) and buy_size_d < gty_d and bb_l == now_close and buy_size_d < gty_c and buy_stop !=1 and sell_stop2 !=1:
                        print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=round(((g*qb1)+qa)*now_qty20,0) ,price =now_close,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                    else:
                        pass
                ...
                #공매도 주문
                for g in range(0, 100):
                    if now_close == round((bb_u) +(g*0.0001),4) and sell_size_d < gty_d and bb_u < now_close and sell_stop !=1 and buy_stop2 !=1:
                    ...
                    #  현재가가 볼린저라인에 걸리면 1배레버리지 수량만큼사질때까지 주문넣어라
                    elif now_close == round((bb_u) +(g*0.0001),4) and sell_size_d < gty_d and bb_u == now_close and sell_size_d < gty_c and sell_stop !=1 and buy_stop2 !=1:
                        print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=round(((g*ql1)+qa)*now_qty20,0) ,price =now_close,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                    else:
                        pass
            ...
            #30분봉기준 볼린저이탈 1.5%~5.5% 지정가매수주문넣기
            # if (bb_l_30 > now_close ) and  buy_cls == 0 and (time_s == 0 or time_s ==1) :
            #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_c/8,0),price =round(bb_l_30-(bb_l_30*0.015),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_c/4,0),price =round(bb_l_30-(bb_l_30*0.025),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_c/2,0),price =round(bb_l_30-(bb_l_30*0.035),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_c/1,0),price =round(bb_l_30-(bb_l_30*0.045),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_c/0.5,0),price =round(bb_l_30-(bb_l_30*0.055),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
                

            # elif (bb_u_30 < now_close ) and  sell_cls == 0 and (time_s == 0 or time_s ==1):
            #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_c/8,0),price =round(bb_u_30+(bb_u_30*0.015),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_c/4,0),price =round(bb_u_30+(bb_u_30*0.025),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_c/2,0),price =round(bb_u_30+(bb_u_30*0.035),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_c/1,0),price =round(bb_u_30+(bb_u_30*0.045),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_c/0.5,0),price =round(bb_u_30+(bb_u_30*0.055),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            # else:
            #     pass
        ...
        #지정가 청산주문
        if time_s == 30 or time_s == 31  or re_len > 99 :
            print(client.LinearOrder.LinearOrder_cancelAll(symbol=ticker).result()) # 모든주문취소
        else:
            pass
        if (buy_close_len > 1 or sell_close_len > 1) and (math.ceil(buy_size/100) == math.ceil(sell_size/100)):
            print(client.LinearOrder.LinearOrder_cancelAll(symbol=ticker).result()) # 모든주문취소
        else:
            pass
        ...
        #지정가 청산주문
        if buy_size_d < gty_c and math.ceil((buy_size_d)/ssall) != math.ceil(buy_close2/ssall) and buy_size > sell_size:
        ...
        elif buy_size_d >= gty_c and buy_close2 ==0  and buy_size > sell_size:
            ...
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round((buy_size_d)/10,0) ,price =round(buy_entry_price+0.0011,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
        ...
        if sell_size_d < gty_c  and math.ceil((sell_size_d)/ssall) != math.ceil(sell_close2/ssall)  and buy_size < sell_size :                
        ...
        elif sell_size_d >= gty_c and sell_close2 ==0  and buy_size < sell_size:
            ...
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round((sell_size_d)/10,0) ,price =round(sell_entry_price-0.0011,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
        ...
        # 양매수 수량줄이기
        if buy_size_e != 0 and buy_entry_price+0.01 < now_close and round(bb_u_30+0.0004,4) < now_close and buy_size_e !=0:
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Market",qty=round(buy_size_e,0),price = round(bb_u_30+0.0004,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
            
        elif sell_size_e != 0 and sell_entry_price-0.01 > now_close and round(bb_l_30-0.0004,4) > now_close and sell_size_e !=0:
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=round(sell_size_e,0),price = round(bb_l_30-0.0004,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
    ...
    # 수량이 차면 양매수를 걸어라
        if buy_size_d > gty_b and ((buy_size_d/2)-sell_cls) > gty_b/2 and round(bb_l-(bb_l*0.01),4) < now_close:
        ...
        elif sell_size_d > gty_b and ((sell_size_d/2)-buy_cls) > gty_b/2 and round(bb_u+(bb_u*0.01),4) > now_close:
        ...
        #  #동시청산 양매수합산 15배를 초과하면 하락시 공매수를먼저 지정가로 청산하고 동시에 같은수량만큼 시장가로 공매도 청산 상승시는 반대로
        # #공매수청산
        # if buy_size+sell_size > gty_c*15 and now_close < buy_entry_price and buy_size > sell_size and (buy_size-buy_close)>(gty_c*6) and (sell_entry_price-buy_entry_price)>0.0004:
        #     print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=sell_size,price = round(now_close+0.0001,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
        #     size1=buy_size-sell_size
        #     size2=sell_size
        # else:
        #     pass
        # if buy_size <= size1+1000 and sell_size >= size2 and now_close < buy_entry_price and size2 !=0:
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=size2,price = now_close,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
        #     size2=0
        # else:
        #     pass

        # #공매도청산
        # if buy_size+sell_size > gty_c*15 and now_close > sell_entry_price and buy_size < sell_size and (sell_size-sell_close)>(gty_c*6) and (sell_entry_price-buy_entry_price)>0.0004:
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=buy_size,price = round(now_close-0.0001,4),time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())
        #     size3=sell_size-buy_size
        #     size4=buy_size
        # else:
        #     pass
        # if sell_size <= size3+1000 and buy_size >= size4 and now_close > sell_entry_price and size4 !=0:
        #     print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Market",qty=size4,price = now_close,time_in_force="GoodTillCancel",reduce_only=True, close_on_trigger=False).result())    
        #     size4=0
        # else:
        #     pass
        ...
        if close_all_3 >= (0.0003/now_close) and buy_size != 0 and sell_size != 0:
        ...
        #=================모든수량 동시청산시 수익나는 시점에 청산후 리셋=============
         #양매수 시장가 청산하기    0.01= 1%수익
        # if close_a_3 >= (0.0004/now_close) and buy_size != 0 and sell_size != 0:
        ...
        if buy_size > 0 and sell_size == 0 and round(buy_entry_price+buy_j3,4) <= now_close:
        ...
        if buy_size ==0  and sell_size > 0  and round(sell_entry_price-buy_j3,4) >= now_close:
        ...
        print(close_a_3)
        print(close_all_3)
        print(round(((1*qb1)+qa)*now_qty20,0))
        print(now_qty20)
        print(gty_b)
        print(gty_c)
        print(buy_entry_1)
        ...
        print(buy_size)
        print(buy_close)
        print(math.floor(sell_entry_1*400))
        print(sell_entry_price-buy_entry_price)
        print(buy_size+sell_size)
        print(math.ceil(buy_size/100))
        print(math.ceil(sell_size/100))
        print("실행중")
