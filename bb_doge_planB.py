...
while True:
    try:
       ...
       #========================================각 포지션별 주문 갯수 구하기=========================================================================
        ...
        #청산가격 무조건 3틱
        buy_j4 = round(now_close*0.004,4)
        #1%
        ...
        if (bb_l > now_close ) and  buy_cls == 0  and my_leverage != 50  and my_stop==0 and buy_size < (gty_c*10):
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+0),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+1),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+2),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+3),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+4),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+5),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/10*now_qty20,0),price =round(now_close-(buy_j5+6),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/9*now_qty20,0),price =round(now_close-(buy_j5+8),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/8*now_qty20,0),price =round(now_close-(buy_j5+15),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/7*now_qty20,0),price =round(now_close-(buy_j5+20),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Buy",symbol=ticker,order_type="Limit",qty=round(gty_buy/6*now_qty20,0),price =round(now_close-(buy_j5+25),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())

            

        elif (bb_u < now_close ) and  sell_cls == 0  and my_leverage != 50 and my_stop==0 and sell_size < (gty_c*10):
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+0),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+1),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+2),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+3),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+4),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+5),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/10*now_qty20,0),price =round(now_close+(buy_j5+6),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/9*now_qty20,0),price =round(now_close+(buy_j5+8),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/8*now_qty20,0),price =round(now_close+(buy_j5+15),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/7*now_qty20,0),price =round(now_close+(buy_j5+20),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
            print(client.LinearOrder.LinearOrder_new(side="Sell",symbol=ticker,order_type="Limit",qty=round(gty_sell/6*now_qty20,0),price =round(now_close+(buy_j5+25),4),time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result())
        else:
            pass
        
        #지정가 청산주문
        if buy_size_d < gty_c and math.ceil((buy_size_d)/ssall) != math.ceil(buy_close2/ssall) and buy_size > sell_size and my_leverage != 50 and my_stop==0 and my_tep1==0:
        ...
        elif buy_size_d < gty_c and math.ceil((buy_size_d)/ssall) != math.ceil(buy_close2/ssall) and buy_size > sell_size and my_leverage != 50 and my_stop==0 and my_tep1==1 and buy_entry_price <= now_close:
        ...
        elif buy_size_d >= gty_c and buy_close2 ==0  and buy_size > sell_size and my_leverage != 50 and my_stop==0 and my_tep1==0 and buy_entry_price <= now_close:
        ...
        # 동시청산주문이후 남은 포지션 평단가로 정리해서 위험회피
        elif buy_size_d >= gty_c and buy_close2 ==0  and buy_size > sell_size and my_leverage != 50 and my_stop==0 and my_tep1==1:
        ...
        # 동시청산주문이후 남은 포지션 평단가로 정리해서 위험회피
        if sell_size_d < gty_c  and math.ceil((sell_size_d)/ssall) != math.ceil(sell_close2/ssall)  and buy_size < sell_size  and my_leverage != 50 and my_stop==1 and my_tep1==1 and sell_entry_price >= now_close:
        ...
        elif sell_size_d >= gty_c and sell_close2 ==0  and buy_size < sell_size and my_leverage != 50 and my_stop==0 and my_tep1==0 and sell_entry_price >= now_close:
        ...
        # 동시청산주문이후 남은 포지션 평단가로 정리해서 위험회피
        elif sell_size_d >= gty_c and sell_close2 ==0  and buy_size < sell_size and my_leverage != 50 and my_stop==0 and my_tep1==1:
    ...
    # 수량이 차면 양매수를 걸어라
        ...
        if buy_size > gty_c*25 and buy_size > sell_size:
            ...
            pass
        if sell_size > gty_c*25 and buy_size < sell_size:
