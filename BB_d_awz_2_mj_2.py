...
client = bybit.bybit(test=False, api_key="Vjg5WzzkBsU6CZ2rlw", api_secret="0mhxLgoJRSJMSGmEfz5L8oIBJcn0Z86vsU2c")
apiKey='Vjg5WzzkBsU6CZ2rlw'
apisecret='0mhxLgoJRSJMSGmEfz5L8oIBJcn0Z86vsU2c'
session = HTTP(
    endpoint='https://api.bybit.com', 
    api_key="Vjg5WzzkBsU6CZ2rlw",
    api_secret="0mhxLgoJRSJMSGmEfz5L8oIBJcn0Z86vsU2c")
...
while True:
    try:
        ...
        if 300 > my_usdt:
            ...
            now_qty20 = round((70000*now_close)/60,0)
        elif 300 < my_usdt and (buy_geb > 0.03 or sell_geb > 0.03) and my_usdt > 50000:
            now_qty20 = round((70000*now_close)/30,0)
        else:
            pass
        ...
        if time_s == 0 or time_s==1: # 초단위 카운팅 0 = 1분
            ...
            if sell_size != 0 and sell_geb < 0.03 and sell_size < gty_d:
                ...
                pass
            #손절하기
            if (round(abs(0.0040/now_close),4) < buy_geb or round(abs(0.004/now_close),4) <sell_geb) and (sell_size_d > gty_d or buy_size_d >= gty_d):
            ...
            elif (round(abs(0.0020/now_close),4) < buy_geb or round(abs(0.0025/now_close),4) <sell_geb) and (sell_size_d > gty_d or buy_size_d >= gty_d):
