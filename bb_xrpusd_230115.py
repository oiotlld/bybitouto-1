...
while True:
    try:
        ...
        if 50 >= leverage >45: # 1/15
            le_1 = 50
        elif 45 >= leverage > 40: # 1/20
            le_1 = 45
        elif 40 >= leverage > 35: # 1/25
            le_1 = 40
        elif 35 >= leverage > 30: # 1/30
            le_1 = 35
        elif 30 >= leverage > 25: # 1/35
            le_1 = 30
        elif leverage < 30: # 1/40
            le_1 = 25
        else:
            pass
        ...
        if time_m ==0 and (time_s ==0 or time_s ==1 or time_s ==2 ) and leverage_btc !=50:
            ...
            pass
        if my_date_len_btc==0 and bb_u_60_eth < now_close_1_btc  and size_btc < my_qty_1_btc*le_8  and size_btc != 0 and leverage_btc !=50:
