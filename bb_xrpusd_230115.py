...
while True:
    try:
        ...
        # 공매도
        if my_date_len == 0 and size == 0  and round((bb_u_60*(1)),4) <= now_close_1  and size<my_qty*6 and en_p <= now_close_1:
        ...
        elif side=="Sell" and entry_price*0.992 > now_close_1  and my_qty*1 < size <= my_qty*2 :
        ...
        elif side=="Sell" and entry_price*0.994 > now_close_1  and my_qty*2 < size <= my_qty*3 :
        ...
        elif side=="Sell" and entry_price*0.995 > now_close_1  and my_qty*3 < size <= my_qty*4 :
        ...
        elif side=="Sell" and entry_price*0.996 > now_close_1  and my_qty*4 < size <= my_qty*5 :
        ...
        elif side=="Buy" and entry_price*1.007 < now_close_1  and my_qty*1 < size <= my_qty*2 :
        ...
        elif side=="Buy" and entry_price*1.006 > now_close_1  and my_qty*2 < size <= my_qty*3 :
        ...
        elif side=="Buy" and entry_price*1.005 > now_close_1  and my_qty*3 < size <= my_qty*4 :
        ...
        elif side=="Buy" and entry_price*1.004 > now_close_1  and my_qty*4 < size <= my_qty*5 :
        ...
        # # #각 포지션 평균단가 가저오기
        # # # 내 포지션 정보가저오기
        my_infor_btc=session.my_position(symbol="ETHUSD")
        # print(my_infor_btc)        
        ...
        # print(entry_price)
        # 내자산가저오기
        myxrp_btc=session.get_wallet_balance(coin="ETH")
        my_equity_btc= float(myxrp_btc["result"]["ETH"]['equity'])

        # 현재가가저오기
        now_close_btc=session.orderbook(symbol="ETHUSD")
        ...
        # 주문내역 받아보기
        my_data_1_btc=session.get_active_order(symbol="ETHUSD",order_status="New")
        ...
        if my_qty_1_btc > size_btc and round(my_qty_btc-size_btc,0) > 5 and size_btc != 0:
            print(session.place_active_order(symbol="ETHUSD",side="Sell",order_type="Market",price=round((now_close_1_btc+(0.0002)),2),qty=round(my_qty_1_btc-size_btc,0),time_in_force="GoodTillCancel"))
