        ...
        if time_s == 0 or time_s==1: # 초단위 카운팅 0 = 1분
            ...
            if bb_l < now_close < bb_u:
                ...
                for z, x in zip(qty_l, price_l):
                    if now_close <= average20 and buy_size < 500:
                    ...
                    elif now_close >= average20 and sell_size < 500:
                    ...
                    if now_close <= average20 and 1000 > buy_size > 500:
                    ...
                    elif now_close >= average20 and 1000 >sell_size > 500:
                    ...
                    if now_close <= average20 and 2000 > buy_size > 1000:
                    ...
                    elif now_close >= average20 and 2000 >sell_size > 1000:
                    ...
                    if now_close <= average20 and 4000 > buy_size > 2000:
                    ...
                    elif now_close >= average20 and 4000 >sell_size > 2000:
                    ...
                    if now_close <= average20 and 8000 > buy_size > 4000:
                    ...
                    elif now_close >= average20 and 8000 >sell_size > 4000:
                    ...
                    if now_close <= average20 and 16000 > buy_size > 8000:
                    ...
                    elif now_close >= average20 and 16000 >sell_size > 8000:
                    ...
                    if now_close <= average20 and  buy_size > 16000:
                    ...
                    elif now_close >= average20 and sell_size > 16000:
