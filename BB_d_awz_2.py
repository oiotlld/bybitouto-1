...
while True:
    try:
        ...
        if time_s == 0 or time_s==1: # 초단위 카운팅 0 = 1분
            ...
            if buy_size != 0 and buy_geb < 0.03  :
                pp=[0,0.0001,0.0002]
                for m in pp:
            ...
            if sell_size != 0 and sell_geb < 0.03:
                pp=[0,0.0001,0.0002]
                for m in pp:
            ...
            if buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0116:
            ...
            elif buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0081:
            ...
            elif buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0069:
            ...
            elif buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0041:
            ...
            elif buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0022:
            ...
            elif buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0014:
            ...
            elif buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0008:
            ...
            elif buy_size >= gty_d  and buy_geb > 0.03 and bb_low > 0.0004:
            ...
            if sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0116:
            ...
            elif sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0081:
            ...
            elif sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0069:
            ...
            elif sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0041:
            ...
            elif sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0022:
            ...
            elif sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0014:
            ...
            elif sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0008:
            ...
            elif sell_size >= gty_d  and sell_geb > 0.03 and bb_high > 0.0004:
