...
while True:
    try:
        ...
        if 300 > my_usdt:
            ...
            now_qty20 = round((my_usdt/4000/now_close),0)
        elif 300 < my_usdt and (buy_geb > 0.03 or sell_geb > 0.03) and my_usdt < 50000:
            now_qty20 = round((my_usdt/4000/now_close),0)
        
        elif 300 < my_usdt and buy_geb < 0.03 and sell_geb < 0.03 and my_usdt > 50000:
            now_qty20 = round((50000/4000/now_close),0)
        elif 300 < my_usdt and (buy_geb > 0.03 or sell_geb > 0.03) and my_usdt > 50000:
            now_qty20 = round((50000/4000/now_close),0)
        else:
            pass
        ...
        if time_s == 0 or time_s==1: # 초단위 카운팅 0 = 1분
            ...
            if bb_l < now_close < bb_u:
                qty_l=[1,2,5,8,15,35,60,90,125,170,220,280,400,535,1945]
                price_l=[0.000125818,0,0.000487329,0.001461988,0.002436647,0.003411306,0.004873294,0.007309942,0.009746589,0.012183236,0.014619883,0.019493177,0.03411306,0.048732943]
