...
while True:
    try:
        ...
        if 500 > my_usdt:
            ...
            now_qty20 = (9000/now_close)/50000
        elif 10000 < my_usdt:
            now_qty20 = (9000/now_close)/50000
        else:
            pass
        ...
        #지정가 청산주문
        if (time_s == 2 or time_s==10 or time_s==20 or time_s==30 or time_s==40 or time_s==50) and now_close > buy_entry_price-0.001 :
        ...
        if now_close >= buy_entry_price+0.0006 and 0 < buy_size <= gty_d:
        ...
        if now_close <= sell_entry_price-0.0006 and 0 < sell_size <= gty_d:
