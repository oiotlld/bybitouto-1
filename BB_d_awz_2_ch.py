    ...
    try:
        ...
        if time_s == 0 or time_s==1: # 초단위 카운팅 0 = 1분
            ...
            if bb_l < now_close < bb_u:
                ...
                price_l=[0,0,0.000487329,0.001461988,0.002436647,0.003411306,0.004873294,0.007309942,0.009746589,0.012183236,0.014619883,0.019493177,0.03411306,0.048732943]
